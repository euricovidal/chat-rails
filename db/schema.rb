...
ActiveRecord::Schema.define(version: 2021_11_02_211940) do
  ...
  create_table "chat_groups", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_chat_groups_on_name", unique: true
  end
  ...
  create_table "chat_messages", force: :cascade do |t|
    ...
    t.index ["to_user_id"], name: "index_chat_messages_on_to_user_id"
